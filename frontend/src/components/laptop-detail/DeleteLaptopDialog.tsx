...
export const DeleteLaptopDialog = ({
  isOpen,
  onOpenChange,
  laptopId,
  laptopName,
  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={onOpenChange}>
      <AlertDialogContent className="bg-gray-900 border-white/10">
        <AlertDialogHeader>
          <AlertDialogTitle className="text-white">Delete Laptop Confirmation</AlertDialogTitle>
          <AlertDialogDescription className="text-white/80">
            Are you sure you want to delete laptop "{laptopName}" (ID: {laptopId})? 
